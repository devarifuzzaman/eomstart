                                    ...
                                    <div className="gi-footer-links gi-footer-dropdown">
                                        <ul className="align-itegi-center flex flex-wrap">
                                            <li className="gi-footer-link pr-[5px]">
                                                <a href="#" className="h-[30px] w-[30px] bg-[#4b5966] rounded-[5px] capitalize flex items-center justify-center text-[15px]"><i className="gicon gi-facebook text-[16px] text-[#fff]" aria-hidden="true"></i></a>
                                            </li>
                                            <li className="gi-footer-link pr-[5px]">
                                                <a href="#" className="h-[30px] w-[30px] bg-[#4b5966] rounded-[5px] capitalize flex items-center justify-center text-[15px]"><i className="gicon gi-twitter text-[16px] text-[#fff]" aria-hidden="true"></i></a>
                                            </li>
                                            <li className="gi-footer-link pr-[5px]">
                                                <a href="#" className="h-[30px] w-[30px] bg-[#4b5966] rounded-[5px] capitalize flex items-center justify-center text-[15px]"><i className="gicon gi-linkedin text-[16px] text-[#fff]" aria-hidden="true"></i></a>
                                            </li>
                                            <li className="gi-footer-link pr-[5px]">
                                                <a href="#" className="h-[30px] w-[30px] bg-[#4b5966] rounded-[5px] capitalize flex items-center justify-center text-[15px]"><i className="gicon gi-instagram text-[16px] text-[#fff]" aria-hidden="true"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
